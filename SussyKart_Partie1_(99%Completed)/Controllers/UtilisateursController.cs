...
namespace SussyKart_Partie1.Controllers
{
    public class UtilisateursController : Controller
    {
        ...
        public async Task<IActionResult> Profil()
        {
            ...
            CompteBancaire? compteBancaire =(await _context.CompteBancaires.FromSqlRaw(query, parameters.ToArray()).ToListAsync()).FirstOrDefault();
            // Dans tous les cas, on doit envoyer un ProfilVM à la vue.
            return View(new ProfilVM() {
                Pseudo = utilisateur.Pseudo,
                DateInscription = utilisateur.DateInscription,
                Courriel = utilisateur.Courriel,
                NoBancaire = compteBancaire == null ? "Inconnue" :  compteBancaire.NoCompteBancaire
            }) ;
        }
    }
}
